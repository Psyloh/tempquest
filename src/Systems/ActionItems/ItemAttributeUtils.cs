...
namespace VsQuest.Util
{
    public static class ItemAttributeUtils
    {
        public const string AttrPrefix = "vsquest:attr:";
        ...
        {
            string langKey = $"vsquest:attr-{shortKey}";
        ...
        public static void ApplyActionItemAttributes(ItemStack stack, ActionItem actionItem)
        {
            ...
            {
                stack.Attributes.SetString("vsquest:showAttrs", JsonConvert.SerializeObject(actionItem.showAttributes));
            }

            if (actionItem.hideVanillaTooltips != null && actionItem.hideVanillaTooltips.Count > 0)
            {
                stack.Attributes.SetString("vsquest:hideVanilla", JsonConvert.SerializeObject(actionItem.hideVanillaTooltips));
            }
        }
    }
}
